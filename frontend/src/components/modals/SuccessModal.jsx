...
const SuccessModal = ({ message, onClose }) => {
  return (
    <Dialog open onClose={onClose} aria-labelledby="success-dialog-title" >
      <DialogTitle id="success-dialog-title" sx={{background:colorPallete.successModalBackgroundColor, color: colorPallete.successPageNormalText, textAlign:'center', fontWeight:'bold', fontSize:'2rem'}}>CHANAGE DONE <DoneIcon sx={{ color: colorPallete.successPageNormalText, textAlign:'center', fontWeight:'bold', fontSize:'2rem'}}/></DialogTitle>
