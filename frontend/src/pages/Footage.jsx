      ...
      <Grid container spacing={3} my={2}>
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ p: 2, textAlign: 'center' }}>
            ...
            <Typography variant="caption" color="text.secondary">Total Cameras</Typography>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ p: 2, textAlign: 'center' }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ p: 2, textAlign: 'center' }}>
            <Typography variant="h5">{Math.floor(Math.random() * 10) + 5}</Typography>
            <Typography variant="caption" color="text.secondary">Motion Events</Typography>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ p: 2, textAlign: 'center' }}>
            <Typography variant="h5">{Math.floor(Math.random() * 50) + 20} GB</Typography>
              ...
              <CardContent>
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">{camera.room}</Typography>
                  </Box>
                  <Avatar
                    sx={{
                      bgcolor:
