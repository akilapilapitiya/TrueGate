...
const colorPallete = {
  ...
  pageBackgroundColorLogin: `radial-gradient(circle at 20% 30%, rgba(255, 0, 128, 0.2), transparent 25%),
      radial-gradient(circle at 80% 70%, rgba(0, 204, 255, 0.15), transparent 30%),
      linear-gradient(135deg, #0f0c29, #302b63, #ff007f, #000000)`,
  pageBackgroundColorRegister: `radial-gradient(circle at 20% 30%, rgba(255, 0, 128, 0.2), transparent 25%),
      radial-gradient(circle at 80% 70%, rgba(0, 204, 255, 0.15), transparent 30%),
      linear-gradient(135deg, #0f0c29, #302b63, #ff007f, #000000)`,
  pageBackgroundColorLanding: `radial-gradient(circle at 20% 30%, rgba(255, 0, 128, 0.2), transparent 25%),
      radial-gradient(circle at 80% 70%, rgba(0, 204, 255, 0.15), transparent 30%),
      linear-gradient(135deg, #0f0c29, #302b63, #ff007f, #000000)`,
  pageBackgroundColorProfile: `radial-gradient(circle at 20% 30%, rgba(255, 0, 128, 0.2), transparent 25%),
      radial-gradient(circle at 80% 70%, rgba(0, 204, 255, 0.15), transparent 30%),
      linear-gradient(135deg, #0f0c29, #302b63, #ff007f, #000000)`,
